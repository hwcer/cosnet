...
func New(ctx context.Context, handler Handler) *Engine {
	i := &Engine{
...
func (this *Engine) SCC() *utils.SCC {
	return this.scc
}

func (this *Engine) Size() int {
	return this.Array.Size()
}

// New 创建新socket并自动加入到Sockets管理器
func (this *Engine) New(conn net.Conn, netType NetType) (sock *Socket, err error) {
	if this.Handler == nil {
...
func (this *Engine) Range(fn func(socket *Socket) bool) {
...
func (this *Engine) heartbeat(ctx context.Context) {
...
func (this *Engine) Close(timeout time.Duration) error {
	if !this.scc.Cancel() {
		return nil
	}
...
func (this *Engine) Socket(id interface{}) (socket *Socket) {
	switch id.(type) {
	case string:
...
func (this *Engine) Player(id interface{}) (player *Player) {
	switch id.(type) {
	case string:
...
func (this *Engine) Broadcast(msg Message, filter func(*Socket) bool) {
